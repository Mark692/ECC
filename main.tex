...
\begin{enumerate}
    ...
    \begin{figure}[ht]
        \includegraphics[width=.6\textwidth,center]{P+(-P)}
        \caption{Curva $y^2 = x^3-7x+10$, $P=(1, 2)$}
    \end{figure}
...
%
\begin{figure}[ht]
    \includegraphics[width=.8\textwidth,center]{ECmodp}
...
\begin{figure}[ht]
    \includegraphics[width=.6\textwidth,center]{ECmodRetta}
...
\end{enumerate}
\includegraphics[scale=0.45]{RSAvECC}
\\
%\includegraphics[scale=0.55]{RSAvECCkeys}
